...
public class Login {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(login(username, decrypt("8fwDlVnA3oNT+o75S8bXxQ==", new SecretKeySpec(Arrays.copyOf(mac_address.getBytes("UTF-8"), 16), "AES"))));
	}
